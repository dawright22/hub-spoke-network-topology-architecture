...
<img width="600" alt="Architecture-diag" src=https://github.com/dawright22/hub-spoke-network-topology-architecture/blob/main/hub-spoke-network-topology-architecture.vsdx>